...
namespace RuneMagic
{
    ...
    public static class SpellGrammar
    {
        ...
        static SpellGrammar()
        {
            ...
            Register(RuneId.Plant, RuneId.Salt, SpellShape.Shot, SpellId.WoodArrow, "Wood arrow", "Compressed. Catalog: Plant · Salt · Mercury. A vegetable body given a shaft and sent. Wood flies.");
