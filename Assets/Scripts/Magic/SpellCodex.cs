...
namespace RuneMagic
{
    ...
    public static class SpellCodex
    {
        ...
        static CodexEntry[] BuiltIn() => new[]
        {
            ...
            E(87, SpellBook.GrowHeal, SpellId.Tree, "A living vegetable body given a standing body. A tree. Over a pit it must join two floors, or it falls. On water it grows a walkable cover without banks. Hunger eats it.", "Tree", "Water · Salt · Earth · Life · Salt", "Plant · Life · Salt", "Pillar", SpellOutcome.Neither),
            E(88, SpellBook.GrowHeal, SpellId.WoodWall, "A living plant asked to stand as more living plant. A line of trees. Across a pit it is a two-tile span that must find floor or wall at each end, or it falls. On water it grows a walkable cover without banks. Hunger eats it.", "Wood-wall", "Water · Salt · Earth · Life · Salt · Water · Salt · Earth · Life", "Plant · Life · Salt · Plant · Life", "Pillar", SpellOutcome.Neither)
        };
        ...
        static void ValidateFills(List<string> broken)
        {
            ...
            {
                broken.Add("Weather names and Grove must not be runes — Tree and weather are spells");
            }
