...
namespace RuneMagic
{
    ...
    public static class SpellCodex
    {
        ...
        static CodexEntry[] BuiltIn() => new[]
        {
            ...
            E(18, SpellBook.Cross, SpellId.IcePillar, "Hard water asked to rest as a column. Over a pit it must join two floors, or it falls. On water it freezes the pool around it without banks, the same ice-wall face as ice-wall. It will thaw.", "Ice-pillar", "Water · Earth · Salt · Earth", "Ice · Salt · Earth", "Pillar", SpellOutcome.Restrain),
            ...
            E(114, SpellBook.Weather, SpellId.AirWall, "The hop sent as a gust. Click start and stop. A wall of air blows them that way.", "Air-wall", "Air · Salt · Air · Mercury", "", "Pillar", SpellOutcome.Restrain),
