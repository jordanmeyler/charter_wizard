...
namespace RuneMagic
{
    ...
    public static class SpellCodex
    {
        ...
        static CodexEntry[] BuiltIn() => new[]
        {
            ...
            E(30, SpellBook.Hold, SpellId.Vine, "The vegetable body sent. A climbing line from you to the mark. It holds them, and hunger can run it as a wick.", "Vine", "Water · Salt · Earth · Mercury", "Plant · Mercury", "Shot", SpellOutcome.Restrain),
