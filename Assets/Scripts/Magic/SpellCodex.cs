...
namespace RuneMagic
{
    ...
    public static class SpellCodex
    {
        static readonly CodexEntry[] Entries =
        {
            ...
            E(33, SpellBook.Cross, SpellId.Hop, "Breath given a body, marked living, sent. A leap.", "Hop", "Air · Salt · Life · Mercury", "", "Spread", SpellOutcome.Neither),
            E(34, SpellBook.Cross, SpellId.Flight, "Breath going; a body of it; marked living; going again.", "Flight", "Air · Mercury · Salt · Life · Mercury", "Wind · Salt · Life · Mercury", "Self", SpellOutcome.Neither),
