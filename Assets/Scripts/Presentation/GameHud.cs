    ...
    public sealed class GameHud : MonoBehaviour
    {
        ...
        void DrawCharter()
        {
            ...
            GUI.Label(new Rect(28, 50, 900, 22),
                "A chain is a sentence. Two runes birth a join or wait. Charter wants the whole recipe. Free fills a blank.",
                body);
        ...
        string TargetLine()
        {
            ...
            var ready = _director.Held.Occupied
                ? $"Press F or click the slot to aim {_director.Held.Name}."
