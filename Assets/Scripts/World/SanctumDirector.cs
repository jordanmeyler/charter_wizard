...
namespace RuneMagic
{
    ...
    public sealed class SanctumDirector : MonoBehaviour
    {
        ...
        static string HintFor(SpellId spell, SpellShape shape)
        {
            ...
            {
                return "Click to keep the breath on you. Walk while it lasts — pits will not take you, and a wall you stood will not stop you. Recast the same sentence to land.";
            }
