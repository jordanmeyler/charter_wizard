...
namespace RuneMagic
{
    ...
    public sealed class MapPainterWindow : EditorWindow
    {
        ...
        void DrawPaintTools()
        {
            ...
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.HelpBox("Left click paints a tile. Shift-click places the prop. Alt-click clears a stamp. The browser editor in Tools/map-editor.html is the fuller painter.", MessageType.None);
        }
