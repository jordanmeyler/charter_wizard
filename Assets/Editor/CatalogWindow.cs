    ...
    public sealed class CatalogWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            EditorGUILayout.HelpBox(
                "Recipes live in Assets/Resources/Catalog/spells.json — that is the master book the game loads. Sprites and items live in art.json. Stones are prefabs under Assets/Prefabs — any folder is fine. Sprite sheets: Window → Rune Magic → Sprite Sheet.",
                MessageType.Info);
