    ...
    public sealed class AuthoringWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.HelpBox(
                ...
                "2. Main already has a Map (Grid + Tiles + Decor + Cover). Extra Floor / Walls / Coverings children are fine — Play merges them. Interactables are GameObjects, not a tile layer.\n" +
                "3. Window → 2D → Tile Palette → open Rune Palette. Select Tiles and paint. Select Decor for plants and furniture. Select Cover for ice / fire / aura.\n" +
                "4. Or paint looks first from any ElvGames palette, then Window → Rune Magic → Tile Properties and click cells to set kind / material / cover. Select Decor to stamp plants that burn off the floor.\n" +
