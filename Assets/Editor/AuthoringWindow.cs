    ...
    public sealed class AuthoringWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.HelpBox(
                ...
                "3. Window → 2D → Tile Palette → open Rune Palette. Select Tiles and paint. Select Environment Details for plants and furniture. Select Environment Details lvl 2 for a second stack on those cells. Details sit on the wall or floor underneath — they do not rewrite it. Select Cover for ice / fire / aura. Hide a layer in Tile Properties, the Rune Layers Scene overlay, or the Hierarchy eye so you can paint the tiles under it.\n" +
