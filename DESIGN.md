...
- [~] **Learning surface** — Play sight hides names; the Charter wall always holds the eleven roots so a sentence can be written. Remembered joins still sit beside them. Later: keep-conditions by rune depth (a variety of casts, and other gates). The Develop ledger remains the full book.
