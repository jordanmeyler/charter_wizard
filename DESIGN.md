...
**Statuses share one host.** Burning, Frozen, Soaked, Stunned, Sleeping, Rooted, Frightened, Raging, Charmed, Confused, Poisoned, Zombified are debuffs. Veiled is a hide buff — enemies lose the trail. Flight is a short float. **Wards** are an element given a body and held on you (`Element · Salt · Sulphur`). A flame ward turns Fire, not lava or witchfire. An air ward also refuses wind-push. Plant ward is the living plant stood (`Plant · Life · Salt · Sulphur`). **Forms** are the higher hold. Gale-form is invisible. Cloud-form flies. Only one ward or form stands at a time. Recast the same sentence to let a ward, form, veil, flight, or mind hold go.
