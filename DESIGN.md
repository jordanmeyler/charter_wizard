...
Tiles keep live state: **Fire**, **Wet**, **Charge**, **Growth**. Plant a vegetable body (`Sprout`) and water it with a spell — the patch grows toward Grove, and a low sentence may take **one** neighboring water floor or water covering. Call-growth takes two. **Forest** (`Plant · Life · Anima · Plant · Life`) drinks every water still on the screen. A short douse only wets what it hits. Stamps and covers do not start that work. Fire a spell starts still spreads onto flammable neighbors. When the clock is spent the plant gains an **ash covering** and the walk becomes **dirt** (look and Earth) if the floor itself was fuel; masonry stays stone under the ash. Fire cover wears off. Retardant neighbors quench. Charge walks **conductive** tiles (metal, water, wet stone, vein). Neutral stone can take a bolt but will not pass it unless a neighbor conducts. Wood and plants **insulate** — they break the path, even on metal. Overlays (`tile-fire`, `tile-wet`, `tile-charge`, `tile-grow`) make the reaction visible.

Marquee reactions (each a puzzle key):
- **Lightning + Water(floor) → conduction** — charge runs the pool.
- **Fire + Plant/Wood → spreading burn** — wood burns better than plant. Wood is two seconds and runs harder; plant lasts three. Grove is a weak run. Ember (5s) stays put. When the clock is spent the tile **gains an ash covering**; a plant or timber floor becomes dirt (look and Earth). Masonry stays. Fire cover wears off.
...
- **Water + Plant → growth** — a player or NPC plant or water spell grows a vegetable body toward Grove. Reach is the sentence: douse stays put, Sprout / Rain take one wet neighbor, Call-growth / Monsoon take two, **Forest** covers every water still on the screen. Dry pits, stamps, and covers do not start a spread. Hunger spent on a plant **adds an ash covering** and turns a plant floor to dirt. Masonry under a burned table stays stone.
