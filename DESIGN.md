...
Each material now carries three numbers you can tweak in `MaterialCatalog.Flag`:

| Flag | Negative | Zero | Positive |
| --- | --- | --- | --- |
| **Flammability** | Fire-retardant — puts nearby fire out (water −1.6, ice −0.85, rain −1.1) | Will not catch | How readily hunger takes it (plant 1.5, timber 1.2, grove 1.35) |
| **Conductivity** | — | Insulator | How freely a spark travels (metal 1.6, water 1.25, vein 0.85) |
| **BurnRate** | — | Does not carry the flame | How fast hunger leaves this cell, and how fast the cell burns out (oil 2.4, dust 1.1, plant 0.85, timber 0.45) |
