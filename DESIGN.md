...
- **Water + Plant → growth** — a player or NPC water spell grows a vegetable body toward Grove. That plant may spread onto **one neighboring tile that already holds water** (a water floor or a water covering). Dry pits, stamps, and covers do not start a spread. Hunger spent on a plant **adds an ash covering**; the walk tile stays.
