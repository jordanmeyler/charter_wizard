...
| **BurnSeconds** | — | Not fuel | How long a full fire lasts (oil 5s, wood 4s, plant 3s, grove 4s, ember 5s) |
| **BurnRate** | — | Ember (5s) stays put | Clock leftover (`5 − seconds`: oil 0, wood 1, plant 2, grove 1). Spread uses Hunger. |
...
- **Fire + Plant/Wood → spreading burn** — wood lasts longer than plant. Wood is four seconds; plant lasts three. Grove is a weak run. Ember (5s) stays put. When the clock is spent the tile **gains an ash covering**; a plant or timber floor becomes dirt (look and Earth). Masonry stays. Fire cover wears off.
