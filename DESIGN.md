...
**Statuses share one host.** Burning, Frozen, Soaked, Stunned, Sleeping, Rooted, Frightened, Raging, Charmed, Confused, Poisoned are debuffs. Veiled is a hide buff — enemies lose the trail. **Wards** are an element given a body and held on you (`Element · Salt · Sulphur`). Plant ward is the living plant stood (`Plant · Life · Salt · Sulphur`). **Forms** are the higher hold. Gale-form is invisible. Cloud-form flies. Only one ward or form stands at a time.
