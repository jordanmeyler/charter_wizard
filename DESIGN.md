...
- **Water · Salt · Earth → Ice** — hard water that thaws, and **a walkable freeze over a pool**. Ice-pillar, Ice-wall, Ice-spear, and Snowfall freeze water tiles. **Heat lives on the recipe** (`MatterLaw`): any fire-bearing sentence melts ice it crosses, including room ice, not only a conjured pillar. Glacier and glass need **witchfire** (`Flame` = Fire · Sulphur · Fire). Grave-ice (Water · Salt · Death) is Free/arcane.
