...
| --- | --- | --- | --- |
| **Flammability** | Fire-retardant — puts nearby fire out (water −1.6, ice −0.85, rain −1.1) | Will not catch | How readily hunger takes it (oil 2.2, plant 1.6, timber 1.2, grove 0.85) |
...
| **BurnSeconds** | — | Not fuel | How long a full fire lasts (oil 1s, plant 2s, wood 3s, grove 4s, ember 5s) |
| **BurnRate** | — | Slow fuel — burns in place (4s+) | How hard hunger runs (derived: oil 3, plant 2, wood 1) |
...
- **Fire + Plant/Wood → spreading burn** — more flammable finishes sooner. Plant is two seconds and runs harder than wood (three seconds). Grove and ember are slow (4–5s) and burn in place. Cover clears to Ash when the clock is spent.
