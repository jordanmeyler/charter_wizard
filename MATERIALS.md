...
| **Fire** | Fire | Fire | Rest stamp. Weak source, not fuel. Speaks Fire. The room is at rest: it lights adjacent covers (vine / plant). It does not light a floor or wall beside it until a spell starts hunger. Cover-Fire is the live layer: standing on it burns, and it lights adjacent covers the same way. |
...
A **kindled hall** is the **Aura-Fire** brush (or a Flame Hall plaque): painted walk that stays lit until yield is thrown. It is not a material — it is a source. Live Aura-Fire, a geyser, or lit Floor-Fire counts as Hunger **10**. Floor-Fire / Wall-Fire stay at rest until a spell or covering starts work — plant on that walk lights the vine, not the masonry. Vine is a wick: any adjacent live flame can run that line, and a burning plant covering lights adjacent wood and oil. Stamp **Cover-Vine** (or write Vine / Sprout) to let fire cross a stone gap; Floor-Plant and Floor-Grove catch and burn out, they do not run a field. **Ember** is coals: it provides fire, accepts a flame from another source, and lets hunger walk across. The tile underneath stays embered even after everything around it burns. Neutral stone / dirt never catch from a neighbor.
