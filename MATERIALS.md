...
| **1** | Tinder | Within **2** of a *stronger* live source | No | 5 | Ember |
| **2** | Tinder | Within 2 of Hunger **> 2** | No | 4 | Dust, fire cover |
| **3** | Soft | Within 2 of Hunger **> 3** | No | 3 | Moss |
| **4** | Soft | Within 2 of Hunger **> 4** | No | 4 | Grove |
| **5** | Plant | Within 2 of Hunger **> 5** | No | 3 | Open — thatch / young plant |
| **6** | Plant | Within 2 of Hunger **> 6** (timber, oil, a hall) | No — a plant field does not run | 3 | Living plant |
| **7** | Timber | Adjacent from Hunger ≥ 7 | Yes — adjacent equal-or-weaker | 2 | Open — brush / dry wood |
| **8** | Timber | Adjacent from Hunger ≥ 7 | Yes | 2 | Timber |
| **9** | Oil | Adjacent; flashes a slick if oil | Yes | 1 | Open — pitch / grease |
| **10** | Oil / hall | Adjacent; oil flashes a connected slick | Yes | 1 | Oil. Kindled hall counts as 10 |
