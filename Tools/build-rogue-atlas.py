...
def build_tiles() -> dict:
    tiles = [
        ...
        tile("wall-ice", "RA_Sanctuary", 2, 1, "wall", "Ice wall. Same sanctuary face as ice-shot / ice-column freeze on water."),
        ...
        tile("cover-ice", "RA_Sanctuary", 2, 1, "cover", "Ice sheet. Same Wall-Ice face as ice-wall and ice-column freeze on water."),
        tile("cover-ice-b", "RA_Sanctuary", 1, 1, "cover", "Ice variant from the same sanctuary ice row as wall-ice."),
