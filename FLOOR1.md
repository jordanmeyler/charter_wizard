...
- **Intended:** **Charm** (`Life · Sulphur · Mercury`). Columns write that sentence. Charmed bodies walk to nearby artifacts, pick them up, and bring them to you — and they fight anything you have already marked. The hold is concentration: reuse Life, Sulphur, or Mercury and they wake. A wall will not break it.
...
- **Statuses are visible.** A chip over a body names burning, frozen, soaked, stunned, sleeping, rooted, frightened, raging, charmed, confused, poisoned, the four wards, veiled. **Burning and poison are meters** — they run down to ash or death, and the HUD shows the clock. A later fire or blight does not refill it. Yield puts hunger out. Fire-nature will not burn; earth shrugs off heat and wet; mind takes stun and fear harder. Wards fend off the element they beat. **Focus holds mind spells**, including wards — they stay until you write another sentence that shares a mark. A fizzle shows the hold breaking. Frost, stun, and root lift on their own. Ice-spear does not freeze the living. Fire, ice, and earth do not take poison. Timber and plant become ash. **Vine** is a climbing shot that hunger can run as a wick.
- **Death is the crystal.** A slam, a fireball, an arrow, a standing flame, or a kindled hall sends you to spawn and **names what found you**. Catch fire or take poison and a **meter** runs down — empty is ash or death. If a spell unmade you, the crystal shows the **marks that wrote it**. Pits and drowning water use the last safe floor.
