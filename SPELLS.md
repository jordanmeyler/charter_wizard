...
| 102 | Breath given logos and breath again, stood, held. Air cannot take you. Fog and foul breath leave as you walk. | Gale-form | Air · Animus · Air · Salt · Sulphur | — | Self | Neither |
...
A **form** is the same sentence with a different root: **Element · matching stance · Element · Salt · Sulphur**. Animus shares Fire and Air. Anima shares Water and Earth. Flame-form is `Fire · Animus · Fire · Salt · Sulphur` (`Flame · Salt · Sulphur` when Flame already stands). Tide-form is `Water · Anima · Water · Salt · Sulphur`. Stone-form is `Earth · Anima · Earth · Salt · Sulphur`. Gale-form is `Air · Animus · Air · Salt · Sulphur`. Grove-form keeps Life, because Plant is not living until Life: `Plant · Life · Anima · Plant · Life · Salt · Sulphur`. A later join that carries both sides — Lava, Steam, Cloud, Dust, Oil — must write **both** stances, in the order those roots first appear.
