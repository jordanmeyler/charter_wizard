...
```
Hop:      Air · Salt · Air
              ├─ Mercury              Air-wall   the leap sent as a span
...
**Blink** adds Spark. The hop becomes a spark-jump. A wall will not stop you. **Teleport** shows that spark-leap (Light). Anywhere you can see. **Flight** adds Animus, then Mercury. Logos asserts the hop into a walk of the air. **Air-wall** is the Mercury-only branch — Hop sent, not kept on you. Float (`Air · Mercury · Salt`) is the other order: going, then stood. You hang. It does not start from Hop.
