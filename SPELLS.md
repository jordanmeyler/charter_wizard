...
| 34 | Breath given logos and breath again, going, then stood on you. You fly. Recast the same breath to land. Pits will not take you while it lasts. | Flight | Air · Animus · Air · Mercury · Salt | — | Self | Neither |
...
| 130 | The seed going, then stood on you. You jump as the spark. A wall will not stop you. | Blink | Fire · Air · Mercury · Salt | Spark · Mercury · Salt | Self | Neither |
| 131 | The seed is withheld, then shown, going, stood on you. You leave and arrive anywhere you can see. | Teleport | Fire · Air · Dark · Light · Mercury · Salt | Spark · Dark · Light · Mercury · Salt | Self | Neither |

**Blink and Teleport sit with Hop.** Hop is a physical leap (`Air · Salt · Air`) — breath given a body, then more breath. A wall stops it. **Blink** is the spark's jump (`Spark · Mercury · Salt` / `Fire · Air · Mercury · Salt`). Lightning already sends that seed (`Spark · Mercury`). Adding Salt stands the going on you, the way Float stands breath on you (`Air · Mercury · Salt`). Float hangs. Blink jumps. A wall will not stop the spark. **Teleport** is that same jump with the veil drawn and lifted (`Spark · Dark · Light · Mercury · Salt`) — withheld, shown, going, stood. Longer because more happened. Click anywhere the camera can see.
...
**Life** is not a school. It is the mark that the recipe is *about a living thing*. Sprout without Life is a seed. Hop is breath given a body (Air · Salt · Air) and does not need Life. Float is breath going, then stood (`Air · Mercury · Salt`) — you hang; wind and vine move you. Flight is breath given logos (`Air · Animus · Air · Mercury · Salt`). **Blink** is the spark's version of that stand-after-going (`Spark · Mercury · Salt`) — the seed jumps you a short way, and a wall will not stop you. **Teleport** is that same jump with the veil drawn and lifted (`Spark · Dark · Light · Mercury · Salt`) — you vanish and appear anywhere you can see. Call without Life is a statue.
