...
- In the Charter: **click wall runes** or weave cells to string them (up to 8). The eleven roots always sit on the wall and in the weave so a sentence can be written. **Air is ambient** wherever a room still holds breath. **You** are always mind · body · soul. Two runes birth a join or wait; a finished spell is a sentence. Then **Charter Cast**, **Store**, or **Free Cast**.
