...
- In the Charter: **click wall runes** or weave cells to string them (up to 8). In Play the wall is kept marks plus any wrought join the room is speaking (Spark, Ice, Plant…). In Develop the eleven and the elemental joins are named; off-screen marks stay grey. Only runes **on screen** light up. **Air is ambient** wherever a room still holds breath. **You** are always mind · body · soul. Walk to bring other missing runes into view. Two runes birth a join or wait; a finished spell is a sentence. Then **Charter Cast**, **Store**, or **Free Cast**.
