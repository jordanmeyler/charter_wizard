...
- In the Charter: **click wall runes** or weave cells to string them (up to 8). Hover a mark to see where it is from — **Light** from the spawn crystal, **Dark** from the pit, **Air** from breath, stone from the floor. The eleven roots always sit on the wall and in the weave so a sentence can be written; a root no tile spoke reads **always ready**. Play also offers kept marks and any wrought join the room is speaking (Spark, Ice, Plant…). Develop names the eleven and the elemental joins; a join that is not in view stays grey. **Air is ambient** wherever a room still holds breath. **You** are always mind · body · soul. Two runes birth a join or wait; a finished spell is a sentence. Then **Charter Cast**, **Store**, or **Free Cast**.
