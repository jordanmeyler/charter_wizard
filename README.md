...
| Chains, not pairs | The catalog spells resolve in play. Fireball is Fire · Air · Mercury — a moving spark, no Salt. The Grimoire lists them all; click a name to string it. |
