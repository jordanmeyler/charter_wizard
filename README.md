...
- In the Charter: **click wall runes** or world glyphs to string them (up to 8). The wall is the eleven basic runes plus what the room is holding. Two runes birth a join or wait; a finished spell is a sentence. **Cast** to aim, or **Store** one string to hold.
