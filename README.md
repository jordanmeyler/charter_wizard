...
Walk into a pit — or into water — and you return to the last safe floor. You cannot swim. Ice, a span, hop, or flight crosses the pool. A slam, an arrow, a wizard’s fireball, or **eight seconds standing in flame** without a water ward **kills** you — you wake at the **spawn crystal**, and the work you stood in that room falls. Douse the floor or wear `Water · Salt · Sulphur`. Fire is orange hunger; **Flame** (`Fire · Sulphur · Fire`) is violet witchfire, a stronger fire. Any fire-bearing sentence melts ice it crosses. A pillar or wall fills a hollow (a wall is start-to-stop: a span over the drop, a barrier on the floor). Hop leaps a few tiles and can clear a shot. Flight lets you walk over pits for a short while.
